  ...
  return (
    <div className="flex justify-center flex-row h-[calc(100%-56px)] dark:bg-black bg-white">
      <div className="w-full max-w-[1280px] flex flex-col lg:flex-row" >
        <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
          ...
          <div className="flex justify-between flex-col md:flex-row mt-4">
            ...
            <div className="flex dark:text-white mt-4 md:mt-0">
              <div className="flex items-center justify-center h-11 px-6 rounded-3xl dark:bg-white/[0.15] font-semibold bg-gray-200">
                <AiOutlineLike className="text-xl dark:text-white mr-2" />
                <span>{`${abbreviateNumber(video?.stats?.likes, 2)} Likes`}</span>
              </div>
              <div className="flex items-center justify-center h-11 px-6 rounded-3xl dark:bg-white/[0.15] font-semibold bg-gray-200 ml-4">
        ...
        <div className="flex flex-col py-6 px-4 overflow-y-auto scrollbar-hide max-h-full lg:w-[350px] xl:w-[400px]">
          {
